...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      NUM('q3', 'Is a default of 24 months following closure of the last linked care item defensible, with organizations able to configure between 6 and 84 months and no option to retain indefinitely?'),
