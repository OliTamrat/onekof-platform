...
export function DualCalendar({
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex flex-col gap-4 border-b border-gray-200 dark:border-[#2C333A] bg-white dark:bg-[#22272B] p-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="rounded-lg border border-gray-300 dark:border-[#2C333A] bg-white dark:bg-[#22272B] p-2 hover:bg-gray-50 dark:hover:bg-[#282E33] transition-colors"
                aria-label="Previous month"
              >
                <ChevronLeft className="h-4 w-4 text-gray-600 dark:text-[#9FADBC]" />
              </button>
              <button
                onClick={goToToday}
                className="rounded-lg border border-gray-300 dark:border-[#2C333A] bg-white dark:bg-[#22272B] px-4 py-2 text-sm font-medium text-gray-700 dark:text-[#9FADBC] hover:bg-gray-50 dark:hover:bg-[#282E33] transition-colors"
              >
                Today
              </button>
              <button
              ...
              >
                <ChevronRight className="h-4 w-4 text-gray-600 dark:text-[#9FADBC]" />
              </button>
            </div>
          </div>
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg border-2 border-[#0065FF] bg-gradient-to-r from-[#0065FF]/10 to-purple-500/10 px-4 py-2 font-medium text-[#0065FF] dark:text-[#0065FF] hover:from-[#0065FF]/20 hover:to-purple-500/20 transition-all shadow-sm"
          >
            <Globe className="h-4 w-4" />
            <span className="text-sm">
              {calendarSystem === 'gregorian' ? 'Gregorian' : 'Ethiopian'} Calendar
            </span>
            <span className="rounded-full bg-[#0065FF]/20 px-2 py-0.5 text-xs">
              Switch
            </span>
          </button>
        </div>
        ...
        {showControls && (
          <div className="flex items-center justify-between">
            {/* View Mode Selector */}
            <div className="flex items-center gap-1 rounded-lg border border-gray-300 dark:border-[#2C333A] bg-white dark:bg-[#22272B] p-1">
              <button
                onClick={() => setViewMode('month')}
                className={`flex items-center gap-2 rounded px-4 py-2 text-sm font-medium transition-colors ${
                  viewMode === 'month'
                    ? 'bg-[#0065FF] text-white shadow-sm'
                    : 'text-gray-700 dark:text-[#9FADBC] hover:bg-gray-100 dark:hover:bg-[#282E33]'
                }`}
              >
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 rounded-lg border px-4 py-2 text-sm font-medium transition-colors ${
                    showFilterPanel
                      ...
                      : 'border-gray-300 dark:border-[#2C333A] bg-white dark:bg-[#22272B] text-gray-700 dark:text-[#9FADBC] hover:bg-gray-50 dark:hover:bg-[#282E33]'
                  }`}
                >
                  <Filter className="h-4 w-4" />
                  Filters
                  {(selectedProjects.length > 0 || selectedStatuses.length > 0) && (
                    <span className="rounded-full bg-[#0065FF] px-2 py-0.5 text-xs text-white">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-[#0065FF] px-4 py-2 text-sm font-medium text-white hover:bg-[#0052CC] transition-colors shadow-sm"
              >
      ...
      <div className="flex-1 overflow-auto">
        {viewMode === 'month' && (
          <div className="p-6">
            <div className="rounded-lg border border-gray-200 dark:border-[#2C333A] bg-white dark:bg-[#22272B] overflow-hidden shadow-sm">
              {/* Weekday Headers */}
              <div className="grid grid-cols-7 border-b border-gray-200 dark:border-[#2C333A] bg-gray-50 dark:bg-[#282E33]">
                {['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'].map((day) => (
                  <div
                    key={day}
                    className="border-r border-gray-200 dark:border-[#2C333A] p-3 text-center text-sm font-semibold text-gray-700 dark:text-[#9FADBC] last:border-r-0"
                  >
                    {day}
                  </div>
                ))}
                ...
                {getCalendarDays().map((date, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={`min-h-[140px] border-b border-r border-gray-200 dark:border-[#2C333A] p-3 last:border-r-0 transition-colors cursor-pointer hover:bg-gray-50 dark:hover:bg-[#282E33] ${
                      ...
                      {date && (
                        <>
                          ...
                          <div className="mb-2 flex items-center justify-between">
                            ...
                            {dayTasks.length > 0 && (
                              <span className="rounded-full bg-[#0065FF]/10 dark:bg-[#0065FF]/20 px-2 py-1 text-xs font-medium text-[#0065FF]">
                                {dayTasks.length}
                              </span>
                            )}
                          </div>
                          ...
                          <div className="space-y-1.5">
                            {dayTasks.slice(0, 3).map((task) => (
                              ...
                              >
                                ...
                                <div className="truncate text-gray-600 dark:text-[#9FADBC]">
                                  {task.title}
                                </div>
                              </div>
                            ))}
                            {dayTasks.length > 3 && (
                              <button
                                ...
                                className="w-full rounded-md bg-gray-100 dark:bg-[#282E33] px-2 py-1.5 text-xs font-medium text-gray-700 dark:text-[#9FADBC] hover:bg-gray-200 dark:hover:bg-[#2C333A] transition-colors"
                              >
        ...
        {viewMode === 'week' && (
          <div className="p-6">
            <div className="rounded-lg border border-gray-200 dark:border-[#2C333A] bg-white dark:bg-[#22272B] overflow-hidden shadow-sm">
              {/* Week Days Header */}
              <div className="grid grid-cols-8 border-b border-gray-200 dark:border-[#2C333A] bg-gray-50 dark:bg-[#282E33]">
                <div className="border-r border-gray-200 dark:border-[#2C333A] p-3 text-center text-xs font-medium text-gray-500 dark:text-[#6B7684]">
                  Time
                </div>
                {(() => {
                  const weekDays = [];
                  ...
                  for (let i = 0; i < 7; i++) {
                    ...
                    weekDays.push(
                      <div
                        key={i}
                        className={`border-r border-gray-200 dark:border-[#2C333A] p-3 text-center last:border-r-0 ${
                          today ? 'bg-[#0065FF]/5' : ''
                        }`}
                      >
                        ...
                        <div className={`mt-1 flex items-center justify-center ${
                          today ? 'rounded-full bg-[#0065FF] text-white p-1' : 'text-gray-900 dark:text-white'
                        }`}>
              ...
              <div className="overflow-y-auto max-h-[600px]">
                {Array.from({ length: 24 }, (_, hour) => {
                  ...
                  return (
                    <div key={hour} className="grid grid-cols-8 border-b border-gray-200 dark:border-[#2C333A] min-h-[60px]">
                      {/* Hour Label */}
                      <div className="border-r border-gray-200 dark:border-[#2C333A] p-2 text-center">
                      ...
                      {Array.from({ length: 7 }, (_, day) => {
                        ...
                        return (
                          <div
                            ...
                            className="border-r border-gray-200 dark:border-[#2C333A] p-1 hover:bg-gray-50 dark:hover:bg-[#282E33] transition-colors cursor-pointer last:border-r-0"
                          >
                            {hourTasks.map((task) => (
                              <div
                                key={task.id}
        ...
        {viewMode === 'day' && (
          <div className="p-6">
            <div className="rounded-lg border border-gray-200 dark:border-[#2C333A] bg-white dark:bg-[#22272B] overflow-hidden shadow-sm">
              {/* Day Header */}
              <div className="border-b border-gray-200 dark:border-[#2C333A] bg-gray-50 dark:bg-[#282E33] p-4">
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <div className="text-right">
                    <div className="text-sm text-gray-600 dark:text-[#9FADBC]">
                  ...
                  {Array.from({ length: 24 }, (_, hour) => {
                    ...
                    return (
                      <div key={hour} className="contents">
                        {/* Time Column */}
                        <div className="border-r border-b border-gray-200 dark:border-[#2C333A] p-3 text-right bg-gray-50/50 dark:bg-[#1B1F23]">
                        ...
                        <div
                          ...
                          className="border-b border-gray-200 dark:border-[#2C333A] p-3 min-h-[80px] hover:bg-gray-50 dark:hover:bg-[#282E33] transition-colors cursor-pointer"
                        >
                              ...
                              <div className="space-y-2">
                                {allDayTasks.map((task) => (
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center gap-3 text-xs text-gray-600 dark:text-[#9FADBC]">
                                      ...
                                      {task.assignee && (
                                        <span className="flex items-center gap-1">
                                          {task.assignee.avatar ? (
                                            ...
                                            <div className="h-4 w-4 rounded-full bg-[#0065FF] flex items-center justify-center text-[8px] text-white font-medium">
          ...
          <div className="p-6">
            <div className="rounded-lg border border-gray-200 dark:border-[#2C333A] bg-white dark:bg-[#22272B] overflow-hidden shadow-sm">
              ...
              <div className="overflow-auto max-h-[700px]">
                ...
                <div className="grid grid-cols-[250px_1fr] border-b border-gray-200 dark:border-[#2C333A] bg-gray-50 dark:bg-[#282E33] sticky top-0 z-10">
                  <div className="border-r border-gray-200 dark:border-[#2C333A] p-3">
                    <span className="text-sm font-semibold text-gray-700 dark:text-[#9FADBC]">Task</span>
                  </div>
                  <div className="grid grid-cols-30 gap-px">
                    {Array.from({ length: 30 }, (_, day) => {
                      ...
                      return (
                        <div
                          key={day}
                          className={`p-2 text-center min-w-[40px] ${today ? 'bg-[#0065FF]/10' : ''}`}
                        >
                          <div className={`text-xs font-medium ${
                            today ? 'text-[#0065FF]' : 'text-gray-600 dark:text-[#9FADBC]'
                          }`}>
                            {date.getDate()}
                          </div>
                          {calendarSystem === 'ethiopian' && (
                            ...
                            <div className="border-r border-gray-200 dark:border-[#2C333A] p-3">
                              ...
                              >
                                <div className="flex items-center gap-2 mb-1">
                                  ...
                                  <span className="font-semibold text-sm text-gray-900 dark:text-white group-hover:text-[#0065FF] transition-colors">
                                    {task.key}
                                  </span>
                                </div>
                                <div className="text-xs text-gray-600 dark:text-[#9FADBC] line-clamp-2">
                                  {task.title}
                                </div>
                                ...
                                >
                                  ...
                                  <div className="absolute bottom-full left-0 mb-2 hidden group-hover:block z-20 whitespace-nowrap">
                                    <div className="bg-gray-900 dark:bg-[#1B1F23] text-white text-xs rounded-lg px-3 py-2 shadow-lg">
                                      ...
                                      <div className="text-gray-300 dark:text-[#9FADBC]">
                                        {startDate.toLocaleDateString()} - {endDate.toLocaleDateString()}
                                      </div>
                                      <div className="text-gray-300 dark:text-[#9FADBC] mt-1">
                                        {duration} days
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  {task.dependencies && task.dependencies.length > 0 && (
                                    <div className="absolute -left-3 top-1/2 -translate-y-1/2">
                                      <div className="flex items-center gap-1">
                                        <GitBranch className="h-3 w-3 text-gray-600 dark:text-[#9FADBC]" />
                                      </div>
                                    </div>
                                  )}
                                </div>
              ...
              {/* Timeline Legend */}
              <div className="border-t border-gray-200 dark:border-[#2C333A] bg-gray-50 dark:bg-[#282E33] p-4">
                <div className="flex items-center gap-6 text-xs">
                  <div className="flex items-center gap-2">
                    <div className="h-2 w-2 rounded-full bg-red-500" />
                    <span className="text-gray-700 dark:text-[#9FADBC]">Critical</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="h-2 w-2 rounded-full bg-orange-500" />
                    <span className="text-gray-700 dark:text-[#9FADBC]">High</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="h-2 w-2 rounded-full bg-yellow-500" />
                    <span className="text-gray-700 dark:text-[#9FADBC]">Medium</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="h-2 w-2 rounded-full bg-blue-500" />
                    <span className="text-gray-700 dark:text-[#9FADBC]">Low</span>
                  </div>
                  <div className="ml-auto text-gray-600 dark:text-[#9FADBC]">
