              ...
              {activeSection === 'general' && (
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-white/50">{t("teamSettings.generalSettingsDesc")}</p>
                  </div>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-[#181D23] rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-white/50 mt-1">{t("teamSettings.allowSelfJoinDesc")}</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-[#181D23] rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-white/50 mt-1">{t("teamSettings.requireApprovalDesc")}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {activeSection === 'notifications' && (
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-white/50">{t("teamSettings.notificationPreferencesDesc")}</p>
                  </div>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-[#181D23] rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-white/50 mt-1">{t("teamSettings.emailNotificationsDesc")}</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-[#181D23] rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-white/50 mt-1">{t("teamSettings.notifyOnInviteDesc")}</p>
                      </div>
                    </div>
                  </div>
                </div>
