      ...
      <div className="flex h-full flex-col bg-gray-50 dark:bg-[#0B0E11]">
        ...
        <div className="border-b border-gray-200 dark:border-white/[0.08] bg-white dark:bg-[#12161B] px-6 py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            {/* Time Range Selector */}
            <div className="flex items-center gap-2 bg-gray-100 dark:bg-[#181D23] rounded-lg p-1">
                ...
                {projects.map((project) => {
                  ...
                  return (
                    <div
                      ...
                      className="rounded-lg border border-gray-200 dark:border-white/[0.08] bg-white dark:bg-[#12161B] overflow-hidden hover:border-[#8B5CF6] dark:hover:border-[#8B5CF6] transition-all hover:shadow-lg cursor-pointer"
                    >
                      {/* Project Header */}
                      <div className="p-6 border-b border-gray-200 dark:border-white/[0.08]">
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <Button className="p-2 hover:bg-gray-100 dark:hover:bg-[#181D23] rounded-lg transition-colors">
        ...
        >
          <SlideoutPanelContent>
            <div className="space-y-6">
              ...
              <div className="rounded-lg border border-gray-200 dark:border-white/[0.08] bg-gradient-to-br from-white to-slate-50 dark:from-[#12161B] dark:to-[#0B0E11] p-6">
              ...
              <div className="rounded-lg border border-gray-200 dark:border-white/[0.08] bg-white dark:bg-[#12161B] p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="h-3 rounded-full bg-gray-200 dark:bg-[#181D23] overflow-hidden">
                      <div
                        className="h-full transition-all"
                        style={{
