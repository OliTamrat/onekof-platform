...
import { BarChart3, Code, FileText, Clock, Book, Settings, Save, Bell, Target, Shield } from 'lucide-react';
              ...
              {activeSection === 'general' && (
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-[#9FADBC]">Configure goal and OKR settings</p>
                  </div>
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-900 dark:text-white mb-2">Default Goal Cycle</label>
                      <select value={settings.defaultCycle} onChange={(e) => setSettings({ ...settings, defaultCycle: e.target.value })} className="w-full rounded-md border border-gray-300 dark:border-[#2C333A] bg-white dark:bg-[#1B1F23] px-3 py-2 text-sm text-gray-900 dark:text-white focus:border-[#0065FF] focus:outline-none focus:ring-2 focus:ring-[#0065FF]/20">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-[#282E33] rounded-lg">
                      <input type="checkbox" id="autoRollover" checked={settings.autoRollover} onChange={(e) => setSettings({ ...settings, autoRollover: e.target.checked })} className="mt-1 h-4 w-4 rounded border-gray-300 text-[#0065FF] focus:ring-[#0065FF]" />
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-[#9FADBC] mt-1">Automatically carry over incomplete goals to next cycle</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-[#282E33] rounded-lg">
                      <input type="checkbox" id="requireOwner" checked={settings.requireOwner} onChange={(e) => setSettings({ ...settings, requireOwner: e.target.checked })} className="mt-1 h-4 w-4 rounded border-gray-300 text-[#0065FF] focus:ring-[#0065FF]" />
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-[#9FADBC] mt-1">All goals must have an assigned owner</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {activeSection === 'notifications' && (
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-[#9FADBC]">Manage goal notifications</p>
                  </div>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-[#282E33] rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-[#9FADBC] mt-1">Receive email updates for goal activity</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-[#282E33] rounded-lg">
                      <input type="checkbox" id="notifyOnProgress" checked={settings.notifyOnProgress} onChange={(e) => setSettings({ ...settings, notifyOnProgress: e.target.checked })} className="mt-1 h-4 w-4 rounded border-gray-300 text-[#0065FF] focus:ring-[#0065FF]" />
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-[#9FADBC] mt-1">Get notified when goal progress is updated</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-[#282E33] rounded-lg">
                      <input type="checkbox" id="weeklyReminders" checked={settings.weeklyReminders} onChange={(e) => setSettings({ ...settings, weeklyReminders: e.target.checked })} className="mt-1 h-4 w-4 rounded border-gray-300 text-[#0065FF] focus:ring-[#0065FF]" />
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-[#9FADBC] mt-1">Receive weekly reminders to update goal progress</p>
                      </div>
                    </div>
                  </div>
                </div>
