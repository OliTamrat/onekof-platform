            ...
            {COLUMNS.map((column) => (
              <div key={column.id} className="flex-shrink-0 w-80 flex flex-col">
                <div className={`flex items-center justify-between mb-4 pb-2 border-b-2 ${column.color}`}>
                  ...
                  <span className="text-sm text-gray-500 dark:text-white/70 bg-gray-100 dark:bg-[#181D23] px-2 py-0.5 rounded-full">
                ...
                <div className="flex-1 space-y-3 overflow-y-auto">
                  {goalsByStatus[column.id]?.map((goal) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1 mt-2 text-xs text-gray-500 dark:text-white/70">
