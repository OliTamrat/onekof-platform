        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gray-200 dark:bg-white/[0.08]" />
                ...
                {Object.entries(groupedProjects).sort(([a], [b]) => new Date(b).getTime() - new Date(a).getTime()).map(([monthYear, monthProjects]) => (
                  <div key={monthYear} className="relative pl-16">
                    <div className="absolute left-0 top-0 flex items-center">
                      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white dark:bg-[#12161B] border-2 border-primary-500">
                    ...
                    <div className="space-y-3">
                      {monthProjects.map((project) => (
                        <div key={project.id} className="p-4 bg-white dark:bg-[#12161B] rounded-lg border border-gray-200 dark:border-white/[0.08] hover:border-primary-500 cursor-pointer transition-colors">
