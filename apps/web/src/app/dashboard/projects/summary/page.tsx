        ...
        <div className="border-b border-gray-200 dark:border-slate-700 bg-white dark:bg-[#22272B]">
          <div className="flex items-center justify-between border-b border-gray-200 dark:border-slate-700 px-6 py-3">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <Plus className="h-4 w-4" />{t("projects.newProject")}</Link>
            </div>
          </div>
                      ...
                      >
                        <div className="w-full flex gap-1 items-end h-48">
                          ...
                          <div className="flex-1 flex flex-col items-center">
                            <div
                              className="w-full bg-primary-500 rounded-t transition-all group-hover:bg-primary-600 group-hover:shadow-lg"
                  ...
                  <div className="space-y-4">
                    {recentActivity.map((activity: { id: string; type: string; project: string; user: string; time: string; avatar: string }) => (
                      <div key={activity.id} className="flex items-start gap-3">
                        <div className="flex-shrink-0 flex h-8 w-8 items-center justify-center rounded-full bg-primary-500 text-xs font-semibold text-white">
                          {activity.avatar}
                        </div>
                        <div className="flex-1 min-w-0">
