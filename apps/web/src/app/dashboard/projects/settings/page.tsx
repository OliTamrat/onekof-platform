...
import { BarChart3, Code, FileText, Clock, Book, Settings, Save, Bell, Users, Shield, Workflow } from 'lucide-react';
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-[#282E33] rounded-lg">
                      <input
                        ...
                        className="mt-1 h-4 w-4 rounded border-gray-300 text-[#0065FF] focus:ring-[#0065FF]"
                      />
