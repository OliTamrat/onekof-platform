...
const TAB_ITEMS = [
  ...
  { id: 'code', label: 'Code', icon: Code, href: '/dashboard/projects/code', active: true },
...
export default function ProjectsCodePage() {
      ...
      <div className="flex h-full flex-col bg-gray-50 dark:bg-[#1B1F23]">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="max-w-2xl text-center">
            ...
            <p className="text-gray-600 dark:text-[#9FADBC] mb-6">Link repositories to track commits, PRs, and branches alongside your projects.</p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
              <div className="p-6 bg-white dark:bg-[#22272B] rounded-lg border border-gray-200 dark:border-[#2C333A]">
                ...
                <p className="text-sm text-gray-600 dark:text-[#9FADBC]">Track code commits linked to projects</p>
              </div>
              <div className="p-6 bg-white dark:bg-[#22272B] rounded-lg border border-gray-200 dark:border-[#2C333A]">
                ...
                <p className="text-sm text-gray-600 dark:text-[#9FADBC]">Monitor PRs and code reviews</p>
              </div>
              <div className="p-6 bg-white dark:bg-[#22272B] rounded-lg border border-gray-200 dark:border-[#2C333A]">
                <GitBranch className="h-8 w-8 text-[#0065FF] mb-3" />
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Branches</h3>
                <p className="text-sm text-gray-600 dark:text-[#9FADBC]">View active feature branches</p>
              </div>
            </div>
            <button
              onClick={() => setShowConnectModal(true)}
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xs text-gray-600 dark:text-[#9FADBC]">Connect your GitHub repositories</div>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xs text-gray-600 dark:text-[#9FADBC]">Connect your GitLab repositories</div>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xs text-gray-600 dark:text-[#9FADBC]">Connect your Bitbucket repositories</div>
                    </div>
                  </button>
                </div>
              </div>
