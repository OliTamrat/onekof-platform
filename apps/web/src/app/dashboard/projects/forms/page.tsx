      ...
      <div className="flex h-full flex-col bg-gray-50 dark:bg-[#0B0E11]">
              ...
              {FORM_TEMPLATES.map((template) => {
                ...
                return (
                  <div
                    ...
                    className={`p-6 bg-white dark:bg-[#12161B] rounded-lg border-2 ${colors.border} hover:border-primary-500 cursor-pointer transition-all group`}
                  >
        ...
        {selectedTemplate && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="w-full max-w-2xl max-h-[90vh] bg-white dark:bg-[#12161B] rounded-lg shadow-xl flex flex-col">
              {/* Modal Header */}
                    ...
                    <div key={index}>
                      ...
                      {field.type === 'text' && (
                        <input
                          ...
                          className="w-full rounded-md border border-gray-300 dark:border-white/[0.08] bg-white dark:bg-[#0B0E11] px-3 py-2 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-[#6B7684] focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
