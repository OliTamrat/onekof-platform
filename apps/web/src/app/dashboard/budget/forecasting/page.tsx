              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
                    {forecasts.map((f) => (
                      <tr key={f.id} className="hover:bg-gray-50 dark:hover:bg-[#181D23]/50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-2">
                            <div className="w-full bg-gray-200 dark:bg-white/[0.08] rounded-full h-2 max-w-[100px]">
                              <div
              ...
              {categoryForecasts.length === 0 ? (
                ...
                <div className="space-y-3">
                  {categoryForecasts.sort((a, b) => b.utilization - a.utilization).map((cat) => (
                    <div key={cat.name} className="flex items-center gap-4 p-3 rounded-lg hover:bg-slate-50 dark:hover:bg-[#181D23]/30 transition-colors">
            ...
            <div className="bg-gradient-to-br from-white to-slate-50 dark:from-[#12161B] dark:to-[#0B0E11] border border-slate-200/50 rounded-xl p-5 md:p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative w-full bg-slate-200 dark:bg-white/[0.08] rounded-full h-4">
                    <div
