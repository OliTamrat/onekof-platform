...
export default function BudgetExpensesPage() {
  ...
  // Demo expenses — ALL tied to Water Dam & Irrigation Project (250M ETB)
  const P = 'Water Dam & Irrigation Project';
  const DEMO_EXPENSES: Expense[] = [
    { id: 'de-1', description: 'RCC dam body concrete — Batch 14 (4,200 m³)', amount: 8400000, currency: 'ETB', status: 'APPROVED', type: 'ACTUAL', transactionDate: '2026-03-15', vendor: 'Ethio-Cement PLC', invoiceNumber: 'EC-2026-0847', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c1', name: 'Dam Construction & Civil Works' } },
    { id: 'de-2', description: 'CAT 390F Excavator & CAT D8T Dozer rental (Q1)', amount: 4200000, currency: 'ETB', status: 'APPROVED', type: 'ACTUAL', transactionDate: '2026-03-13', vendor: 'Mesfin Industrial Engineering', invoiceNumber: 'MIE-4521', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c3', name: 'Heavy Equipment & Machinery' } },
    { id: 'de-3', description: 'Spillway gate fabrication — steel plates & hinges', amount: 6800000, currency: 'ETB', status: 'APPROVED', type: 'ACTUAL', transactionDate: '2026-03-11', vendor: 'Zuquala Steel', invoiceNumber: 'ZS-2026-0389', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c1', name: 'Dam Construction & Civil Works' } },
    { id: 'de-4', description: 'Community resettlement — Woreda 7 (42 households)', amount: 3200000, currency: 'ETB', status: 'PENDING', type: 'ACTUAL', transactionDate: '2026-03-10', vendor: 'Amhara Regional Authority', invoiceNumber: 'ARA-RST-0312', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c7', name: 'Land Acquisition & Resettlement' } },
    { id: 'de-5', description: 'Engineering team salaries — February 2026 (68 staff)', amount: 5400000, currency: 'ETB', status: 'APPROVED', type: 'ACTUAL', transactionDate: '2026-03-05', vendor: 'Internal Payroll', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c4', name: 'Engineering & Labor' } },
    ...
    { id: 'de-7', description: 'SolarTech irrigation pump station — Phase 3 solar array', amount: 5500000, currency: 'ETB', status: 'APPROVED', type: 'ACTUAL', transactionDate: '2026-03-03', vendor: 'SolarTech Ethiopia', invoiceNumber: 'STE-1102', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c2', name: 'Irrigation Canal & Distribution' } },
    { id: 'de-8', description: 'Construction workers wages — Week 36 (320 laborers)', amount: 2800000, currency: 'ETB', status: 'APPROVED', type: 'ACTUAL', transactionDate: '2026-03-01', vendor: 'Internal Payroll', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c4', name: 'Engineering & Labor' } },
    { id: 'de-9', description: 'SMEC International — dam safety review & design audit', amount: 4500000, currency: 'ETB', status: 'APPROVED', type: 'ACTUAL', transactionDate: '2026-02-28', vendor: 'SMEC International', invoiceNumber: 'SMEC-ETH-0156', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c6', name: 'Consulting & Project Management' } },
    { id: 'de-10', description: 'GIS topographic survey — irrigation canal alignment', amount: 2100000, currency: 'ETB', status: 'PENDING', type: 'ACTUAL', transactionDate: '2026-02-26', vendor: 'Esri East Africa', invoiceNumber: 'ESRI-EA-7744', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c2', name: 'Irrigation Canal & Distribution' } },
    { id: 'de-11', description: 'Reinforcement steel bars — 85 tons (dam abutment)', amount: 7200000, currency: 'ETB', status: 'APPROVED', type: 'ACTUAL', transactionDate: '2026-02-24', vendor: 'Habesha Steel', invoiceNumber: 'HS-2026-0456', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c1', name: 'Dam Construction & Civil Works' } },
    ...
    { id: 'de-13', description: 'Pump station concrete works & pipe laying (2.4 km)', amount: 4800000, currency: 'ETB', status: 'APPROVED', type: 'ACTUAL', transactionDate: '2026-02-20', vendor: 'METEC', invoiceNumber: 'METEC-2026-0078', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c2', name: 'Irrigation Canal & Distribution' } },
    ...
    { id: 'de-15', description: 'Crane rental — Liebherr LTM 1300 (dam crest work)', amount: 3800000, currency: 'ETB', status: 'APPROVED', type: 'ACTUAL', transactionDate: '2026-02-15', vendor: 'Sur Construction', invoiceNumber: 'SUR-CR-229', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c3', name: 'Heavy Equipment & Machinery' } },
    { id: 'de-16', description: 'Hydrological monitoring station equipment', amount: 1950000, currency: 'ETB', status: 'APPROVED', type: 'ACTUAL', transactionDate: '2026-02-12', vendor: 'Hach Company', invoiceNumber: 'HACH-ETH-330', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c3', name: 'Heavy Equipment & Machinery' } },
    { id: 'de-17', description: 'EIA compliance audit — Q1 2026 (World Bank requirement)', amount: 2200000, currency: 'ETB', status: 'PENDING', type: 'ACTUAL', transactionDate: '2026-02-10', vendor: 'ERM Consulting', invoiceNumber: 'ERM-ETH-0023', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c5', name: 'Environmental & Social Safeguards' } },
    { id: 'de-18', description: 'Project management office — February operational costs', amount: 1800000, currency: 'ETB', status: 'APPROVED', type: 'ACTUAL', transactionDate: '2026-02-08', vendor: 'Ministry of Water & Irrigation', budget: { id: 'water-dam-budget', project: { name: P } }, category: { id: 'c6', name: 'Consulting & Project Management' } },
