      ...
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {TEMPLATES.map((template) => (
            <div key={template.id} className="bg-white dark:bg-[#22272B] border border-gray-200 dark:border-[#2C333A] rounded-lg p-4 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-[#9FADBC] mb-2">{template.description}</p>
                  <div className="text-xs text-gray-600 dark:text-[#9FADBC]">Used {template.uses} times</div>
                </div>
              </div>
            </div>
          ))}
