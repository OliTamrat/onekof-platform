  ...
  return (
    <AppLayout>
      ...
      {isLoading ? (
        ...
        <div className="bg-white dark:bg-[#0B0E11] min-h-screen">
          {/* Summary Stats */}
          <div className="p-4 md:p-6 border-b border-slate-200 dark:border-white/[0.08]">
          ...
          <div className="p-4 md:p-6 grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="lg:col-span-2 space-y-4 md:space-y-6">
              ...
              {stats?.monthlyTrend && stats.monthlyTrend.length > 0 && (
                <div className="rounded-xl border border-slate-200 dark:border-white/[0.08] bg-white dark:bg-[#12161B] p-4 md:p-6">
                ...
                <div className="rounded-xl border border-slate-200 dark:border-white/[0.08] bg-white dark:bg-[#12161B] p-4 md:p-6">
                  ...
                  <div className="space-y-3">
                    {stats.upcomingMilestones.map((milestone: any) => (
                      <div key={milestone.id} className="flex items-start gap-3 p-2 rounded-lg hover:bg-slate-50 dark:hover:bg-[#181D23]/50 transition-colors">
...
function MetricCard({ icon, label, value, subtitle, color, bgColor }: {
  ...
  return (
    <div className="rounded-xl border border-slate-200 dark:border-white/[0.08] bg-white dark:bg-[#12161B] p-3 md:p-4">
