...
export default function ProjectAutomationPage() {
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center bg-gray-50 dark:bg-[#1B1F23] p-6">
      ...
      <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Automation Rules</h2>
      <p className="text-sm text-gray-600 dark:text-gray-400 text-center max-w-md">
        Create automated workflows and rules for your project. This feature is coming soon.
      </p>
    </div>
  );
}
