      ...
      <nav className="sticky top-0 z-50 border-b border-white/[0.08] bg-[#0B0E11]/90 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-[1200px] items-center justify-between px-6">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary-500 text-[14px] font-extrabold">O</div>
            <span className="text-[16px] font-bold tracking-tight">Onekof</span>
          </Link>
