...
// OAuth provider feature flags — set in Vercel env vars to show each button
const ENABLE_GOOGLE    = process.env.NEXT_PUBLIC_ENABLE_GOOGLE_OAUTH    === 'true';
const ENABLE_MICROSOFT = process.env.NEXT_PUBLIC_ENABLE_MICROSOFT_OAUTH === 'true';
const ENABLE_GITHUB    = process.env.NEXT_PUBLIC_ENABLE_GITHUB_OAUTH    === 'true';
const ENABLE_LINKEDIN  = process.env.NEXT_PUBLIC_ENABLE_LINKEDIN_OAUTH  === 'true';
const ANY_OAUTH_ENABLED = ENABLE_GOOGLE || ENABLE_MICROSOFT || ENABLE_GITHUB || ENABLE_LINKEDIN;
    ...
    <div className="flex min-h-screen bg-[#0B0E11]">
      ...
      <div className="flex w-full items-center justify-center px-4 py-6 sm:px-8 sm:py-8 lg:px-12 lg:py-12 lg:w-1/2">
        <div className="w-full max-w-[420px]">
          ...
          {/* OAuth — each button only renders when its NEXT_PUBLIC_ENABLE_*_OAUTH=true */}
          {ANY_OAUTH_ENABLED && (
