...
export const MINISTRY_PRESET: OrganizationPreset = {
  ...
  enabledSections: ['my-work', 'teams', 'budget', 'goals', 'projects', 'documents', 'docs', 'timeline', 'calendar', 'issues', 'analytics', 'operations', 'research'],
...
export const NGO_PRESET: OrganizationPreset = {
  ...
  enabledSections: ['my-work', 'teams', 'budget', 'goals', 'projects', 'documents', 'docs', 'timeline', 'calendar', 'issues', 'analytics', 'marketing', 'operations', 'research'],
...
export const BUSINESS_PRESET: OrganizationPreset = {
  ...
  enabledSections: ['my-work', 'teams', 'budget', 'goals', 'automations', 'documents', 'docs', 'analytics', 'projects', 'issues', 'calendar', 'timeline', 'development', 'marketing', 'operations'],
...
export const EDUCATION_PRESET: OrganizationPreset = {
  ...
  enabledSections: ['my-work', 'teams', 'budget', 'goals', 'projects', 'documents', 'docs', 'calendar', 'issues', 'timeline', 'research'],
...
export const HEALTHCARE_PRESET: OrganizationPreset = {
  ...
  enabledSections: ['my-work', 'teams', 'budget', 'goals', 'projects', 'documents', 'docs', 'calendar', 'timeline', 'issues', 'analytics', 'operations', 'research', 'medical'],
